...
import org.example.entity.obstacleEntity.movingObstacleEntity.*;
import org.example.entity.obstacleEntity.stillObstacleEntity.*;
...
public class EngelEkle {
    ...
    public ArrayList<Engel> engellerList;
    ...
    private EngelEkle () {
        ...
        this.engellerList=new ArrayList<>();
